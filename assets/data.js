...
const JOURNALS = {
  ...
  "Biological Psychiatry":                            { abbr:"BIOPSY", if:10.3 },
  "Acta Neuropathologica":                            { abbr:"ANP",    if:10.3 },
  "Clinical Nuclear Medicine":                        { abbr:"CNM",    if:9.6  },
  "Journal of Nuclear Medicine":                      { abbr:"JNM",    if:9.6  },
  "Movement Disorders":                               { abbr:"MDJ",    if:7.7  },
  ...
  "Frontiers in Neuroscience":                        { abbr:"FNINS",  if:4.0  },
  "Molecular Brain":                                  { abbr:"MolBr",  if:3.8  },
  "Frontiers in Human Neuroscience":                  { abbr:"FNHUM",  if:3.6  },
  "Biomedical Engineering Letters":                   { abbr:"BMEL",   if:3.4  },
  "Frontiers in Behavioral Neuroscience":             { abbr:"FNBEH",  if:3.4  },
  "Biochemistry and Biophysics Reports":              { abbr:"BBREP",  if:3.3  },
  "Journal of Korean Medical Science":                { abbr:"JKMS",   if:3.2  },
  "Journal of the Neurological Sciences":             { abbr:"JNS",    if:3.1  },
  "Physics in Medicine & Biology":                    { abbr:"PMB",    if:3.1  },
  "Cerebral Cortex":                                  { abbr:"CERCOR", if:3.0  },
  "eNeuro":                                           { abbr:"eNeuro", if:2.6  },
  "Journal of Neuroscience Methods":                  { abbr:"JNSM",   if:2.5  },
  "Tremor and Other Hyperkinetic Movements":          { abbr:"TOHM",   if:1.9  },
  /* no longer indexed in JCR (last JIF 3.9 in 2023) — badge omitted */
  "Aging (Albany NY)":                                { abbr:"AGING" }
};

/* ---------------- Publications ---------------- */
/* d = DOI. 제목을 누르면 https://doi.org/<d> 로 연결됩니다.
   img: "assets/img/pubs/xxx.jpg" 를 추가하면 저널 타일 대신 그 그림이 썸네일로 쓰입니다.
   fa:true = Jeyeon Lee 1저자(†), ca:true = 교신저자(*). 저자 목록의 "Lee J"가 굵게 표시되고 배지가 붙습니다.
...
const PUBS = [
  ...
  { y:2026, ca:true, a:"Park CW, Choi Y, Lee HS, Jeong SH, Lee PH, Kim YJ, Sohn YH, Lee J, Chung SJ", t:"Amyloid-linked trajectories of cerebral hypoperfusion and dopamine loss in dementia with Lewy bodies", j:"Brain", d:"10.1093/brain/awag264", img:"assets/img/pubs/dlb-sustain.webp" },
  { y:2026, ca:true, a:"Sun Y, Choi Y, Park CW, Na HK, Lee HS, Kim YJ, …, Lee J, Chung SJ", t:"Spatiotemporal progression patterns of striatal dopamine depletion and cerebral hypoperfusion in Parkinson's disease", j:"Movement Disorders" , d:"10.1002/mds.70398", img:"assets/img/pubs/pd-dopamine-perfusion.webp" },
  ...
  { y:2026, ca:true, a:"Park CW, Choi Y, Sun Y, Lee HS, Lee PH, Kim YJ, …, Lee J, Chung SJ", t:"Visuospatial dysfunction indicates an increased risk of rapid dementia conversion in Parkinson's disease", j:"Alzheimer's & Dementia, 22(1), e71130" , d:"10.1002/alz.71130", img:"assets/img/pubs/pd-visuospatial.webp" },
  { y:2026, ca:true, a:"Choi SH, Jang DH, Kim IY, Kim DG, Kim HE, Kang J, …, Lee J", t:"Cerebral blood flow estimation using NIRS in cardiac arrest patients: correlation with ROSC outcomes", j:"Resuscitation, 110997" , d:"10.1016/j.resuscitation.2026.110997", img:"assets/img/pubs/nirs-rosc.webp" },
  ...
  { y:2025, me:2, a:"Kim J, Lee J, Lee J, Park HK, Kim IY", t:"Quantitative analysis of the effect of clothing on the oscillometric waveform envelope and oscillometric blood pressure measurements", j:"Biomedical Engineering Letters" , d:"10.1007/s13534-025-00467-7", img:"assets/img/pubs/bp-clothing.webp" },
  { y:2025, ca:true, a:"Kandimalla M, Lim S, Thakkar J, Dewan S, Kang D, In MH, …, Lee J, Min HK", t:"Cardiorespiratory dynamics in the brain: review on the significance of cardiovascular and respiratory correlates in functional MRI signal", j:"NeuroImage, 121000" , d:"10.1016/j.neuroimage.2024.121000", img:"assets/img/pubs/cardioresp-review.webp" },

  /* 2024 */
  { y:2024, fa:true, a:"Lee J, Burkett BJ, Min HK, Senjem ML, Dicks E, Corriveau-Lecavalier N, …, Jones DT", t:"Synthesizing images of tau pathology from cross-modal neuroimaging using deep learning", j:"Brain, 147(3), 980" , d:"10.1093/brain/awad346", img:"assets/img/pubs/tau-synthesis.webp" },
  ...
  { y:2024, fa:true, a:"Lee J, Lim S, Kandimalla M, Ghatamaneni S, Thakkar J, Dewan S, …, Min HK", t:"Respiratory volume changes and CSF circulation during human NREM sleep", j:"Alzheimer's & Dementia, 20, e093200" , d:"10.1002/alz.093200", img:"assets/img/pubs/nrem-csf.webp" },
  ...
  { y:2024, me:2, a:"Lee J, Hwang HB, Lee S, Kim J, Lee J, Kim S, …, Kim IY", t:"Analysis of acute stress reactivity and recovery in autonomic nervous system considering individual characteristics of stress using HRV and EDA", j:"IEEE Access" , d:"10.1109/ACCESS.2024.3437671", img:"assets/img/pubs/stress-hrv-eda.webp" },
  ...
  { y:2024, ca:true, a:"Hwang HB, Lee J, Kwon H, Chung B, Lee J, Kim IY", t:"Preliminary study of novel bio-crypto key generation using clustering-based binarization of ECG features", j:"Sensors, 24(5), 1556" , d:"10.3390/s24051556", img:"assets/img/pubs/biocrypto-ecg.webp" },
  ...
  { y:2023, fa:true, a:"Lee J, Barnard LR, Jones DT", t:"Artificial intelligence and the aging mind", j:"Aging (Albany NY), 15(8), 2815" , d:"10.18632/aging.204644" },
  ...
  /* 2022 */
  { y:2022, fa:true, a:"Lee J, Burkett BJ, Min HK, Senjem ML, Lundt ES, Botha H, …, Jones DT", t:"Deep learning-based brain age prediction in normal aging and dementia", j:"Nature Aging, 2(5), 412–424" , d:"10.1038/s43587-022-00219-7", img:"assets/img/pubs/brain-age.webp" },
  ...
  { y:2022, fa:true, a:"Lee J, Burkett BJ, Min HK, Lundt ES, Albertson SM, Botha H, …, Lowe VJ", t:"The overlap index as a means of evaluating early tau PET signal reliability", j:"Journal of Nuclear Medicine, 63(11), 1748–1753" , d:"10.2967/jnumed.121.263136", img:"assets/img/pubs/overlap-index-jnm.webp" },
  { y:2022, fa:true, a:"Lee J, Kim J, Cortez J, Chang SY", t:"Thalamo-cortical network is associated with harmaline-induced tremor in rodent model", j:"Experimental Neurology, 358, 114210" , d:"10.1016/j.expneurol.2022.114210", img:"assets/img/pubs/thalamocortical-tremor.webp" },
  ...
  { y:2022, fa:true, a:"Lee J, Burkett BJ, Min HK, Senjem ML, Mester CT, Wiste HJ, …, Jones DT", t:"Synthesizing images of tau pathology from images of glucose utilization", j:"Alzheimer's & Dementia, 18, e062011" , d:"10.1002/alz.062011", img:"assets/img/pubs/tau-from-fdg.webp" },
  { y:2022, fa:true, a:"Lee J, Chung JO, Park SY, Rajamohan N, Singh A, Kim J, …, Lee S", t:"Natural COA water inhibits mitochondrial ROS-mediated apoptosis through Plk3 downregulation under STZ diabetic stress in pancreatic β-cell lines", j:"Biochemistry and Biophysics Reports, 30, 101247" , d:"10.1016/j.bbrep.2022.101247", img:"assets/img/pubs/coa-water.webp" },

  /* 2021 and earlier */
  { y:2021, fa:true, a:"Lee J, Min HK, Lundt ES, Albertson SM, Botha H, Senjem ML, …, Lowe VJ", t:"The overlap index: a new means for early detection of serial tau PET signal change", j:"Alzheimer's & Dementia, 17, e053944" , d:"10.1002/alz.053944", img:"assets/img/pubs/overlap-index-serial.webp" },
  ...
  { y:2019, fa:true, a:"Lee J, Jo HJ, Kim I, Lee J, Min HK, In MH, …, Chang SY", t:"Mapping BOLD activation by pharmacologically evoked tremor in swine", j:"Frontiers in Neuroscience, 13, 459486" , d:"10.3389/fnins.2019.00985", img:"assets/img/pubs/swine-bold-tremor.webp" },
  { y:2018, fa:true, a:"Lee J, Choi H, Min K, Lee S, Ahn KH, Jo HJ, …, Lee KM", t:"Right hemisphere lateralization in neural connectivity within fronto-parietal networks in non-human primates during a visual reaching task", j:"Frontiers in Behavioral Neuroscience, 12, 186" , d:"10.3389/fnbeh.2018.00186", img:"assets/img/pubs/monkey-wpli.webp" },
  ...
  { y:2018, me:2, a:"Lee J, Kim I, Lee J, Knight E, Cheng L, Kang SI, …, Chang SY", t:"Development of harmaline-induced tremor in a swine model", j:"Tremor and Other Hyperkinetic Movements, 8" , d:"10.5334/tohm.406" },
  { y:2017, fa:true, a:"Lee J, Choi H, Lee S, Cho BH, Ahn KH, Kim IY, …, Jang DP", t:"Decoding saccadic directions using epidural ECoG in non-human primates", j:"Journal of Korean Medical Science, 32(8), 1243" , d:"10.3346/jkms.2017.32.8.1243" },
  ...
  { y:2013, fa:true, a:"Lee J, Choi H, Kim T, Lee H, Kim IY, Jang DP, …, Lee KM", t:"The effectiveness of epidural ECoG on brain computer interface in primate", j:"International Winter Workshop on Brain-Computer Interface (BCI), 107–108" , d:"10.1109/IWW-BCI.2013.6506647" },
  { y:2013, fa:true, a:"Lee J, Ku J, Han K, Park J, Lee H, Kim KR, …, Kim SI", t:"rTMS over bilateral inferior parietal cortex induces decrement of spatial sustained attention", j:"Frontiers in Human Neuroscience, 7, 26", d:"10.3389/fnhum.2013.00026" }
];
